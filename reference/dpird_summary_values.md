...
A [vector](https://rdrr.io/r/base/vector.html) object containing 75
items representing valid values to supply to `get_dpird_summary()`'s
`values` argument taken from the documentation for the DPIRD Weather 2.0
API.
...
A [vector](https://rdrr.io/r/base/vector.html) object of 75 items.
