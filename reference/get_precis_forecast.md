...
Fetch nicely formatted daily précis forecast from the BOM, which
...
- state:
  ...
  to `AUS` returning all state bulletins, see Details for more.

## Value

A
[`data.table::data.table()`](https://rdrr.io/pkg/data.table/man/data.table.html)
of an Australia BOM précis seven day forecasts for BOM selected towns.
...
Adam H. Sparks, <adamhsparks@gmail.com>, Keith Pembleton,
