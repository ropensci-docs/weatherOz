...
instructions for setting it up so that it’s available in your R session
and {weatherOz} will automatically find it. If you have already set up
an API key, this will return that value for you.
